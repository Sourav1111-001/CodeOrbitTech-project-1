...
RULES = [
    ...
    # Time / Date  (static reply — no live clock needed for rule-based demo)
    ...
    (re.compile(r"\bweather\b|\btemperature\b", re.I),
     "I can't check live weather, but try weather.com or just look outside! 🌤️"),
...
def is_exit(user_input: str) -> bool:
    """Return True if the user wants to quit the chat."""
